...
| 2E | `extract_attributes` | `job_title`, `offer_description` | `seniority`, `is_remote`, `contract_type`, `spoken_languages_required` | LLM | Is included in the description or the title. |
